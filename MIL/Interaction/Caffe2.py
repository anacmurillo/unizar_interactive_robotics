...
CAFFE_MODELS = "Interaction/model/"
...
class skeleton:
    def __init__(self,str):
        ...
        with open(INIT_NET) as f:
            ...
            self.init_def=memonger.optimize_inference_for_dag(self.init_def,['data'])
            # self.init_def = memonger.release_blobs_when_used(self.init_def,set([]))
        ...
        with open(PREDICT_NET) as f:
            ...
            self.net_def = memonger.release_blobs_when_used(self.net_def, set([]))
            print memonger.estimate_memory_usage(net)
            # self.net_def=memonger.optimize_inference_for_dag(self.net_def,['data'])
